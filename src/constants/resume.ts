...
export const WORK_EXPERIENCE: WorkExperience[] = [
  {
    ...
    project: [
      ...
      },
      {
        ...
        description: [
          '미니앱 검수 대기 큐 등록 과정을 자동화하여 휴먼 에러를 제거하고 검수 흐름을 단순화',
          'Google API·Notion API를 활용해 검수 상태 데이터를 자동 적재 및 추적',
          '등록 프로세스 클릭 수를 4회 → 1회로 축소 (200초 → 50초)',
          '<span class="highlight">실제 팀 업무 플로우에 적용되어 QA 효율 향상에 기여</span>',
        ],
      },
    ],
  },
